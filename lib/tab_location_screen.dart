...
class TabLocationScreenState extends State<TabLocationScreen> {
  ...
  static const CameraPosition initialCameraPosition = CameraPosition(target: LatLng(37.42796133580664, -122.085749655962), zoom: 20);
  ...
  @override
  void initState()   {
    position =  Geolocator.getCurrentPosition().then((value) => addToMarker(value)) ;
    super.initState();
  }
  ...
  Future<Position> addToMarker(Position p) async {
    ...
    googleMapController
        .animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: LatLng(p.latitude, p.longitude), zoom: 14)));
    markers.clear();
    ...
    markers.add(Marker(
        ...
        markerId: const MarkerId('currentLocation'),position: LatLng(p.latitude, p.longitude)));
    setState(() {});
    return tmp;
              ...
              child: InkWell(
                child:  Container(
                  ...
                  decoration: BoxDecoration(
                    color: Color.fromRGBO(212, 210, 229,1),
                    borderRadius: BorderRadius.circular(5),
                  ),
                  child: Icon(Icons.notifications_rounded,color: Color.fromRGBO(106, 0, 191,1),),
                ),
                onTap: (){},
              ),
            ),
            ...
            Container(
              ...
              child: InkWell(
                child:  Container(
                  ...
                  child: Icon(Icons.map,color: Color.fromRGBO(106, 0, 191,1),),
                ),
                onTap: changeMapType,
              ),
            ),
